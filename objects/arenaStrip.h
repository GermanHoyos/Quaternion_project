...
void drawStrip()
{
    ...
    DrawLine3D({80.0f, 0.0f, zPosition}, {80.0f, 40.0f, zPosition}, WHITE);
    DrawLine3D({180.0f, 0.0f,zPosition}, {180.0f, 40.0f, zPosition}, WHITE);
    ...
    if (zPosition <= -20.0f) 
    {
      ...
      ///*[z]*/ random_device rd_3; mt19937 gen_3(rd_3()); uniform_real_distribution<float> dis_3(-1000.0f, 1000.0f); 
       ...
       zPosition = 800.0f;
       reflectiveCube refCube = reflectiveCube({dis_1(gen_1), dis_2(gen_2), 800.0f},true);
