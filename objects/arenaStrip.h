...
void drawStrip()
{
    ...
    zPositionBlueLine -= 20.0f;
    if (zPositionBlueLine <= -20.0f) 
    {

        // if the blue line is reset then push an asteroid to the list 
        // Randomize position
        /*[x]*/ random_device rd_1; mt19937 gen_1(rd_1()); uniform_real_distribution<float> dis_1(360.0f, 1500.0f); 
        /*[y]*/ random_device rd_2; mt19937 gen_2(rd_2()); uniform_real_distribution<float> dis_2(120.0f, 350.0f); 
        ...
        reflectiveCube refCube = reflectiveCube({dis_1(gen_1), dis_2(gen_2), -1900.0f}, true, false, false, false);
